...
class RemoteDataSourceImpl implements RemoteDataSource {
  ...
  List<ContestModel> _mockContests() => const [
    ...
    ContestModel(
      id: 'c2',
      title: 'Educational #152',
      contestUrl: '',
      startTime: '2026-02-18T14:00:00Z',
      duration: '2h 0m',
      platform: 'CPD Hub',
      numberOfProblems: 5,
      numberOfContestants: 890,
      date: 'Feb 18, 2026',
      isPast: false,
    ...
    ContestModel(
      id: 'c3',
      title: 'Div. 3 Challenge',
      contestUrl: '',
      startTime: '2026-02-20T16:00:00Z',
      duration: '2h 15m',
      platform: 'CPD Hub',
      numberOfProblems: 7,
      numberOfContestants: 2100,
      date: 'Feb 20, 2026',
      isPast: false,
      isParticipating: false,
    ),
    ContestModel(
      id: 'c4',
      title: 'Weekly Round #48',
      contestUrl: '',
      startTime: '2026-02-01T10:00:00Z',
      duration: '1h 30m',
      platform: 'CPD Hub',
      numberOfProblems: 4,
      numberOfContestants: 560,
      date: 'Feb 1, 2026',
      isPast: true,
      isParticipating: true,
    ),
    ContestModel(
      id: 'c5',
      title: 'Div. 2 Round #890',
      contestUrl: '',
      startTime: '2026-01-25T10:00:00Z',
      duration: '2h 0m',
      platform: 'CPD Hub',
      numberOfProblems: 5,
      numberOfContestants: 1100,
      date: 'Jan 25, 2026',
      isPast: true,
      isParticipating: false,
    ),
  ...
  UserModel _mockProfile() => const UserModel(
    ...
    socialLinks: [
      ...
      SocialLinkModel(
        platform: 'LinkedIn',
        url: 'https://linkedin.com/in/bereket',
        handle: 'Bereket Lemma',
      ),
      SocialLinkModel(
        platform: 'Telegram',
        url: 'https://t.me/bereket_dev',
        handle: '@bereket_dev',
      ),
    ],
  );
  ...
  List<ActivityModel> _mockActivity() => const [
    ...
    ActivityModel(
      id: 'a2',
      username: 'sara',
      action: 'Rating increased to 1450 (+25)',
      type: 'Rating',
    ...
    ActivityModel(
      id: 'a3',
      username: 'dawit',
      action: "earned 'Problem Crusher' badge",
      type: 'Badge',
      timestamp: '1h ago',
    ),
    ActivityModel(
  ...
  List<InfoModel> _mockInfoList() => const [
    ...
    InfoModel(
      ...
      description:
          'Track your coding consistency with the new heatmap feature!',
    ),
    InfoModel(
      title: 'Contest Update',
      description: 'Global Round #26 registration is now open',
    ),
  ];
}
